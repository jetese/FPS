...
public class GameManager : MonoBehaviour {
    ...
    private GameObject m_Player_Gm;
	...
	void Start () {
        ...
        m_Player_Gm = GameObject.FindGameObjectWithTag("Player");
        m_Player = m_Player_Gm.GetComponent<CharacterController>();
        RespawnPlayer();
	}
	...
	public void RespawnPlayer()
	{
        ...
        m_Player_Gm.transform.position = m_CurrentSpawnPoint.position;
        m_Player.SendMessage("ResetHelth", SendMessageOptions.DontRequireReceiver);
