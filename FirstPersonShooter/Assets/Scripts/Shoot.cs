...
public class Shoot : MonoBehaviour
{
    ...
    private Quaternion m_weaponRotation;
    private float suma;
    ...
    private void Start()
    {
        ...
        m_weaponRotation = this.transform.rotation;
    }
    /// <summary>
    ...
    private void ShootRay()
    {
        ...
        if (Physics.Raycast(m_ShootPoint.transform.position, m_ShootPoint.transform.TransformDirection(Vector3.forward), out hit, Mathf.Infinity))
        {
            ...
            if(rb != null && !rb.isKinematic){
                rb.AddForce(m_ShootPoint.transform.TransformDirection(Vector3.forward) * 1000);
            }
            ...
            Instantiate(m_Sparkles, hit.point, transform.rotation);
        }
